# Generated by Powerlevel10k configuration wizard on 2025-07-22 at 00:21 CST.
...
# disconnected, compact, concise, instant_prompt=auto-quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=2 # prev:7
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=2 # prev:7
